...
$(document).ready(function() {
	...
	$("#list1").jqGrid({
	    ...
	    //url:'http://seascapesolutions.com:8080<%=request.getContextPath()%>/grid?type=application',
	    url:'http://localhost:8080<%=request.getContextPath()%>/grid?type=application',
	    colNames:['Student ID','Lastname','MI','Firstname','SSN','DOB','Status','Farm','Location'],
	    colModel:[
	              ...
	              {name:'farm_base',index:'farm_base', width:150},
	              {name:'intake_status',index:'intake_status', width:150},
