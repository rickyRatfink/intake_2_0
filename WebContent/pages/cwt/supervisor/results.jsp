...
<%@ page import="org.faithfarm.domain.Supervisor" %>
<%@ page import="org.faithfarm.util.Validator" %>

<%
	 Validator v8r = new Validator();
	 String message=(String)request.getAttribute("MESSAGE");
	 ArrayList results = (ArrayList) session.getAttribute("Supervisor_results");
	 if (results==null)
        ...
        Course Work Therapy - Supervisor List
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td class="colHeading" width="300">Name</td>
                    <td class="colSpacer" width="1"></td>
                ...
                <% String rowClass="";
				   ...
				   for (int i=0;i<results.size();i++) { 
					  Supervisor p = (Supervisor)results.get(i);
					  if (i%2==0) 
					  	rowClass="Even"; 
					  else 
					    rowClass="Odd";	  
                ...
                <tr>
                    ...
                    <td class="searchRow<%=rowClass%>" ><%=p.getFirstname()%>&nbsp;<%=p.getLastname()%></td>
                    <td class="searchRowSpcr<%=rowClass%>"></td>
            ...
            <tr>
            	<td height="23" valign="center" align="left">
            		<input type="submit" name="action" value="Create Supervisor" class="button"/>
            	</td>
            </tr>
           	</table>
        	</div>
