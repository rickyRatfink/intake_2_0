...
public abstract class BaseDjReportTest extends TestCase {
	...
	protected JRDataSource getDataSource() {
		...
		Collection dummyCollection = dao.getClassListPDF("Orientation", "BOYNTON BEACH");
		System.out.println ("size="+dummyCollection.size());
	...
	public Collection getDummyCollectionSorted(List columnlist) {
		//Collection dummyCollection = TestRepositoryProducts.getDummyCollection();
		Collection dummyCollection = dao.getClassList("Orientation", "BOYNTON BEACH");
